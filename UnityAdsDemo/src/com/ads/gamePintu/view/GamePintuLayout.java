package com.ads.gamePintu.view;
...
import com.ads.gamePintu.MainActivity;
		...
		if (isSuccess)
		{
			...
			MainActivity.getInstance().runOnUiThread(new Runnable(){
				...
				public void run() {
				  ...
				  System.out.println("fetchCompleted= "+MainActivity.getFetchCompleted());
				  if(MainActivity.getFetchCompleted()){
					if(UnityAds.canShow()) {
			...
			Toast.makeText(getContext(), "Success , showing ads..",
